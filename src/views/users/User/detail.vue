        ...
        <b-row v-if="!loading">
            ...
            <b-col md="3" class="mb-4">
                <b-card v-if="user" class="h-100">
                    ...
                    <ErrorNoteForm v-if="getStep(1) && getStep(1).status != 'accepted'" :step="1"
                        :registerStep="getStep(1)" @submitError="handleErrorSubmit" @approveStep="handleApproveStep" />
                </b-card>
            </b-col>
            ...
            <b-col md="3" class="mb-4">
                <b-card v-if="user" class="h-100">
                    ...
                    <ErrorNoteForm v-if="getStep(2) && getStep(2).status != 'accepted'" :step="2"
                        :registerStep="getStep(2)" @submitError="handleErrorSubmit" @approveStep="handleApproveStep" />
                </b-card>
            </b-col>
            ...
            <b-col md="3" class="mb-4">
                <b-card v-if="user" class="h-100">
                    ...
                    <ErrorNoteForm v-if="getStep(3) && getStep(3).status != 'accepted'" :step="3"
                        :registerStep="getStep(3)" @submitError="handleErrorSubmit" @approveStep="handleApproveStep" />
                </b-card>
            </b-col>
            ...
            <b-col md="3" class="mb-4">
                <b-card v-if="user" class="h-100">
                    ...
                    <ErrorNoteForm v-if="getStep(4) && getStep(4).status != 'accepted'" :step="4"
                        :registerStep="getStep(4)" @submitError="handleErrorSubmit" @approveStep="handleApproveStep" />
                </b-card>
            </b-col>
        </b-row>
...
// ساخت لینک فایل
const fileUrl = (path) => (path ? `http://127.0.0.1:8000/storage/${path}` : "#");
